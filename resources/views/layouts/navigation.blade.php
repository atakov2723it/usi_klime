        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="mt-3 space-y-1 px-4 pb-3">
                    <a href="{{ route('login') }}" class="block text-sm font-medium text-gray-700">Login</a>
                    <a href="{{ route('register') }}" class="block text-sm font-medium text-indigo-600">Registracija</a>
                </div>
            @endauth
        </div>
    </div>
